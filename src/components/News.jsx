...
async componentDidMount(){
  let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=5dd2521d30eb4b3981419cf4157ff6f0&pageSize=6";
...
handleNextClick = async () => {
  if(!this.state.page+1>Math.ceil(this.state.totalResults/20)){
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5dd2521d30eb4b3981419cf4157ff6f0&page=${this.state.page + 1}&pageSize=6`;
    let data = await fetch(url);
    let parseData = await data.json()
    this.setState({
